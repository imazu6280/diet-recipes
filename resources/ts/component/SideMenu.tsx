...
import { SideLinkType, SideMenuType } from "../type/sideMenu";
...
export const SideMenu = () => {
    const { open }: SideMenuType = useMenu();
    return (
        <div className="relative">
            ...
            <nav
                className={`absolute top-0 -right-2/4 h-screen flex flex-col gap-y-7 pl-4 pr-6 pt-5 bg-white rounded-lg ${
